    ...
    function ajaxForm(data) {
        $.ajax({
            ...
            success: function(res) {
                ...
                console.log(res.errMsg.inputMsg), res.success ? (alert("登陆成功!"), location.href = loginPort.jump_port) : alert(res.errMsg.inutMsg || res.errMsg.otherMsg ? res.errMsg.inputMsg || res.errMsg.otherMsg : "登陆失败!!!");
            }
        });
    }
    //登陆模块
