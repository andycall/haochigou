    ...
    function ajaxForm(data) {
        $.ajax({
            ...
            success: function(res) {
                ...
                res.success ? (alert("注册成功"), location.href = registerPort.jump_port) : alert(res.errMsg.inputMsg ? res.errMsg.inputMsg : res.errMsg.otherMsg ? res.errMsg.otherMsg : "注册失败!!!");
            }
        });
    }
