define([ "personal/port", "jquery", "jquery.uploadify" ], function(port, $) {
    console.log("personal center loaded"), $(".recent_order").on("click", function() {
        $(".tab_header li").each(function(index, value) {
            $(value).removeClass("active");
        }), $(this).addClass("active"), $(".recent_ticket").show(), $(".recent_month").hide();
    }), $(".recent_deal").on("click", function() {
        $(".tab_header li").each(function(index, value) {
            $(value).removeClass("active");
        }), $(this).addClass("active"), $(".recent_ticket").hide(), $(".recent_month").show();
    }), $(".avatar").on("click", function() {
        $("#upload_btn")[0].click();
    }), $("#user_name").on("blur", function() {
        var user_name = $(this).text();
        console.log(user_name), $.ajax({
